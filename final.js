...
function Collision(circle, othercircle) {
    ...
    if (xVelocityDiff * xDist + yVelocityDiff * yDist >= 0) {
        ...
        const u1 = rotatevelocity(circle.velocity, angle);
        const u2 = rotatevelocity(othercircle.velocity, angle);
